 ...
 * 专利引用数据接口 调用演示
 */
public class QueryPatentCitingDemo {

    private static Logger logger = LoggerFactory.getLogger(QueryPatentCitingDemo.class);
    ...
    public static void main(String[] args){
        ...
        String baseUrl = "http://localhost:8080/api/patent/citing?";
